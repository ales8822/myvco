...
const PrototypeLibrary = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 dark:bg-neutral-950 text-gray-900 dark:text-neutral-100 dark:border-neutral-800 p-6 overflow-hidden min-h-screen transition-colors">
            <LibraryHeader
                navigate={navigate}
