...
export default function CompanyDashboard() {
    ...
    return (
        <div className="flex">
            <Sidebar />
            <div className="ml-64 flex-1 p-8 bg-gray-50 dark:bg-neutral-950 min-h-screen transition-colors">
                        ...
                        <nav className="-mb-px flex space-x-8">
                            <button
                                ...
                                className={`${selectedTab === 'overview'
                                    ...
                                    : 'border-transparent text-gray-500 dark:text-neutral-400 hover:text-gray-700 dark:hover:text-neutral-200 hover:border-gray-300 dark:hover:border-neutral-700'
